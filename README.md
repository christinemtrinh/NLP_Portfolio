...
A [report](Homework7/Homework7_cmt180004.pdf) examining 3 different ML models that attempt sentiment analysis, a common application of NLP. Logistic regression performed best with this data set and chosen hyperparameters.
